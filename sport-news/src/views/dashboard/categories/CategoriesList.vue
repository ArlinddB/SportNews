<template>
  <div class="antialiased w-full min-h-screen text-slate-300 relative py-4">
    <div class="mx-auto gap-2 sm:gap-2 md:gap-4 lg:gap-6 max-w-2xl my-2 px-2">
      <div class="pt-2 pb-6 flex justify-between">
        <router-link :to="{name: 'categories-create-dashboard'}"
      ...
      <div id="content" class="bg-[#17191f] col-span-9 rounded-lg p-6">
        <div id="last-users">
          <h1 class="font-bold py-4 uppercase">Categories</h1>
          <div class="overflow-x-scroll">
            <table class="w-full whitespace-nowrap">
              ...
              <tr
                ...
                v-for="category in this.filteredList"
                :key="category._id"
              >
                ...
                <td>
                  <div class="inline-flex items-center space-x-3">
                    <router-link :to="{name: 'categories-edit-dashboard', params: {id: category._id}}" title="Edit" class="hover:text-white">
                      <svg
                    ...
                    <router-link :to="{name: 'categories-details-dashboard', params: {id: category._id}}" title="Details" class="hover:text-white">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
                        viewBox="0 0 24 24"
                    ...
                    <button title="Delete" @click="handleDeleteCategory(category._id)" class="hover:text-white">
                      <svg
                        viewBox="0 0 24 24"
                        fill="none"
                        stroke-width="1.5"
